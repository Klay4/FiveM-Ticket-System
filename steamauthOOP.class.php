...
class steamauthOOP {
    private $settings = array(
        "apikey" => "8C5A6B8B5012752346ACD04B934A24F0", // Get yours today from http://steamcommunity.com/dev/apikey
        "domainname" => "futureserver.it", // Displayed domain in the login-screen
